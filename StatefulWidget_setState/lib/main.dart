...
class _TeladDesignState extends State<TeladDesign> {
  ...
  final List<String> imagens = [
    ...
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKXxlMXTo6vSs7hXSaVObRudBKA9fM4vKK8Q&s',
  ];
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Botao('Mudar imagem', onPressed: alternarImagem),
              ],
            ),
          ),
          Container(
...
class Botao extends StatelessWidget {
  ...
  const Botao(this.texto, {required this.onPressed});
