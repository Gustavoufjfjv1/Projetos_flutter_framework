...
class TelaXburguer extends StatefulWidget {
  const TelaXburguer({super.key});

  @override
  State<TelaXburguer> createState() => _TelaXburguer();
}

class _TelaXburguer extends State<TelaXburguer> {
