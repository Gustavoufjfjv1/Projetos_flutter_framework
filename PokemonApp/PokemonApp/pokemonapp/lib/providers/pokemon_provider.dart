...
class PokemonProvider extends ChangeNotifier {
  ...
  Future<void> buscarPokemonNome(String nome) async {
    carregando = true;

    notifyListeners();

    pokemons = await PokemonService.buscarPokemonNome(nome);
  ...
  Future<void> buscarPokemonAleatorio() async {
    carregando = true;

    notifyListeners();

    pokemons = await PokemonService.buscarPokemonAleatorio();
